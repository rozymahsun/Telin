...
import sg.telin.util.SpringUtil;
...
//	private Office office;
	...
	public	User getUserLogin(){
		User userLogin = (User) Sessions.getCurrent().getAttribute(Constants.USER_SESSION);
		if(userLogin!=null){
			return userLogin;
		}
		return null;
		...
		User userLogin = new User();
			...
			opr.setOperId("EXL");
			userLogin.setIdOperator("EXL");
			userLogin.setOperator(opr);
			userLogin.setGroupId(1);
...
//		Executions.sendRedirect("/j_spring_logout");
		Executions.sendRedirect("/zkloginDialog.zul");
