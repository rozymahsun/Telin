package sg.telin.backend.test.data;
...
import sg.telin.backend.test.factories.*;
/** 
 * Data layer.
 * @author autogenerated
 */
@org.springframework.stereotype.Component
public class DataLayerTestImpl implements DataLayerTest {
	/** Singleton reference to this class. */
	private static DataLayerTest instance;
	/** map lock. */
 ...
 /** Sessionfactory in use. Filled in by Spring. */ 
	...
	public void setApplicationContext(ApplicationContext ctxt) {
		DataLayerTestImpl.context = ctxt;
	}
	...
	* @return GenericDAO<T, ?> object
		...
		synchronized (daoMapLock) {
    		if (daoMap == null) {
    			daoMap = new ConcurrentHashMap<Class<?>, GenericDAO<?, ?>>(); 
	 	   		daoMap.put(User.class, HibernateTestDaoFactory.getUserDao());
    		}
		 }
    ...
    public void deleteUser(final Integer id)  {
        HibernateTestDaoFactory.getUserDao().delete(loadUser(id));
    }
    ...
    public User loadUser(final Integer id) {
        return HibernateTestDaoFactory.getUserDao().load(id);
    }
    /**
     * Loads the given Object.
     * @param id Id to load
     ...
     */
     public User getUser(final Integer id) {
        return HibernateTestDaoFactory.getUserDao().get(id);
    }  
    /** Returns a singleton instance of this class.
     * @return an singleton instance
     */
    public static synchronized DataLayerTest getInstance() {
        
        if (instance == null) {
        	if (context == null) {
        		throw new IllegalStateException("Context is null. Make sure Spring is initialized.");
        	}
     		instance = (DataLayerTest) context.getBean("dataLayerTestImpl");
        }
